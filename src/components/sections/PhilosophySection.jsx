...
export function PhilosophySection() {
  const containerRef = useInView({ margin: "-10%" });
  ...
  return (
    <Section ref={containerRef} className="bg-base-dark text-white">
      <Container>
        ...
        <div className="flex flex-col items-center text-center mb-8 md:mb-12 pt-4 fade-up">
        ...
        <div
          className="fade-up delay-1 relative w-full aspect-video md:aspect-21/9 bg-white/5 mb-8 md:mb-12 overflow-hidden rounded-xl"
          style={{
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16">
          {philosophies.map((item, i) => (
            <div
              key={item.title}
              className={`fade-up delay-${i + 2} flex flex-col border-t border-white/10 pt-8`}
            >
